...
public class RayCheck : MonoBehaviour
{
    ...
    private void ClimbLadderCheck(bool handCheck)
    {
        ...
        Debug.DrawRay(pm.head.transform.position, -pm.handDirection * handDistance, blockedCheck ? Color.red : Color.green);
        Debug.DrawRay(pm.hand.transform.position, -pm.handDirection * handDistance, handCheck ? Color.red : Color.green);
