...
namespace AlsRitter.PowerUpSystem {
    ...
    public abstract class PowerUp : MonoBehaviour {
        ...
        protected virtual void PowerUpCollected(GameObject gameObjectCollectingPowerUp) {
            ...
            // 但它在游戏对象层次结构中更简洁
            gameObject.transform.DOLocalMove(player.PlayerSelf().gameObject.transform.position, .5f)
                      .OnComplete(() => gameObject.transform.parent = player.PlayerSelf().gameObject.transform);
